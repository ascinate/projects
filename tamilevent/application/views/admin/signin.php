...
<head>
    <title>Admin - Mytamilevent </title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form action="<?php echo base_url();?>admin/login/login_admin" method="post" enctype="multipart/form-data" class="md-float-material form-material">
