                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <form  method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/category/insert" >
                                            <div class="form-group row">
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="file" class="form-control" name="userfile" id="name" placeholder="Enter Category Icon" required>
                                                    <span class="messages"></span>
                                                </div>
                                            </div>
